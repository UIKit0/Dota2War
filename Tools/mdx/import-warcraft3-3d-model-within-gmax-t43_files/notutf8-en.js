...
function insert_plus_menu_new(search_where,session_id,add_favourite,watch_topic) {
	...
	search_where = '&amp;search_where='+search_where;
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div class="overview row3" id="plus_menu" style="display:none;position:absolute;width:400px;margin-top:8px;z-index:1;"><p class="title-overview row2"><strong>Actions !</strong></p><p class="left-overview"><strong><a href="/search.forum?search_id=newposts'+search_where+session_id+'">View posts since last visit</a><br /><a href="/search.forum?search_id=egosearch'+search_where+session_id+'">View your posts</a><br /><a href="/search.forum?search_id=unanswered'+search_where+session_id+'">View unanswered posts</a><br /><a href="/search.forum?search_id=watchsearch'+search_where+session_id+'">Topic being watched</a></strong></p><hr class="dashed" /><p class="left-overview"><strong>'+watch+favourite+'<a href="/tell_friend.forum?f='+search_where+session_id+'">Send to a friend</a><br /><a href="'+self.location.href+'" onclick="link_bbcode();return false">Copy BBCode URL</a><br /><a href="javascript:void(0);" onclick="window.print();return false">Print this page</a></strong></p></div>');
}
